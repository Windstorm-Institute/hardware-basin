...
The full text of this paper is provided as \texttt{paper.pdf} in this repository. The markdown source is in \texttt{paper/Paper9-v2.1-draft.md} in the companion Windstorm-Institute/throughput-basin-origin repository.

\section*{Code and Data Availability}

All code, experimental data, and figures are available under MIT license at \url{https://github.com/Windstorm-Institute/hardware-basin} and \url{https://github.com/Windstorm-Labs/hardware-basin}. The Grand Slam Supplementary Materials providing statistical verification (v2.1) are at \texttt{grandslam\_supplementary.pdf} in this repository.
