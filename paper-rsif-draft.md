...
Paper 7 reported a universal quantization cliff at INT4 to INT3. We investigated whether this cliff is a software artifact or a property of low-precision arithmetic. The cliff location depends on the quantization method. Symmetric uniform quantization produces catastrophic BPT approximately 17 at INT4 (versus 4.3 at FP16). bitsandbytes NF4 produces operational BPT approximately 3.9--4.7 at INT4. Same bit count, opposite outcomes. A Lloyd-Max quantizer achieves per-matrix cosine 0.990 at INT4 and 0.965 at INT3. Universal across four architectures and consistent across all 24 layers. Version 2.1 added three verifications: five-seed replication at Pythia-1.4B (Welch $t = 633.74$, $p = 2.84 \times 10^{-15}$, Cohen's $d = 400.81$); Lloyd-Max INT3 end-to-end failure (BPT = 11.74); and three-model, three-seed robust replication. Version 2.2 (April 2026) adds a methodological-journey narrative (§1.4) tracing the seven rounds of follow-up — including the Round-5 thesis pivot — and an adversarial-review-defense table (§4.6); Zenodo 10.5281/zenodo.19672922. The minimum viable inference specification is not a bit count but a level-allocation strategy.
